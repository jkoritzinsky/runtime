...
uint32_t interceptor_ICJI::getMethodAttribs(CORINFO_METHOD_HANDLE ftn)
{
    mcs->AddCall("getMethodAttribs");
    return original_ICorJitInfo->getMethodAttribs(ftn);
}

void interceptor_ICJI::setMethodAttribs(CORINFO_METHOD_HANDLE ftn, CorInfoMethodRuntimeFlags attribs)
{
    mcs->AddCall("setMethodAttribs");
    original_ICorJitInfo->setMethodAttribs(ftn, attribs);
}

void interceptor_ICJI::getMethodSig(CORINFO_METHOD_HANDLE ftn, CORINFO_SIG_INFO* sig, CORINFO_CLASS_HANDLE memberParent)
{
    mcs->AddCall("getMethodSig");
    original_ICorJitInfo->getMethodSig(ftn, sig, memberParent);
}

bool interceptor_ICJI::getMethodInfo(CORINFO_METHOD_HANDLE  ftn,
...
bool interceptor_ICJI::haveSameMethodDefinition(CORINFO_METHOD_HANDLE meth1Hnd, CORINFO_METHOD_HANDLE meth2Hnd)
{
    mcs->AddCall("haveSameMethodDefinition");
    return original_ICorJitInfo->haveSameMethodDefinition(meth1Hnd, meth2Hnd);
}

CorInfoInline interceptor_ICJI::canInline(CORINFO_METHOD_HANDLE callerHnd, CORINFO_METHOD_HANDLE calleeHnd)
{
...
bool interceptor_ICJI::canTailCall(CORINFO_METHOD_HANDLE callerHnd,
...
void interceptor_ICJI::getEHinfo(CORINFO_METHOD_HANDLE ftn, unsigned EHnumber, CORINFO_EH_CLAUSE* clause)
{
...
void interceptor_ICJI::getMethodVTableOffset(CORINFO_METHOD_HANDLE method,
...
CORINFO_CLASS_HANDLE interceptor_ICJI::getDefaultComparerClass(CORINFO_CLASS_HANDLE elemType)
{
    mcs->AddCall("getDefaultComparerClass");
    return original_ICorJitInfo->getDefaultComparerClass(elemType);
}

CORINFO_CLASS_HANDLE interceptor_ICJI::getDefaultEqualityComparerClass(CORINFO_CLASS_HANDLE elemType)
{
...
bool interceptor_ICJI::satisfiesMethodConstraints(CORINFO_CLASS_HANDLE parent, CORINFO_METHOD_HANDLE method)
{
...
void interceptor_ICJI::getGSCookie(GSCookie* pCookieVal, GSCookie** ppCookieVal)
{
...
void interceptor_ICJI::resolveToken(CORINFO_RESOLVED_TOKEN* pResolvedToken)
{
    mcs->AddCall("resolveToken");
    original_ICorJitInfo->resolveToken(pResolvedToken);
}

void interceptor_ICJI::findSig(CORINFO_MODULE_HANDLE  module,
                               unsigned               sigTOK,
                               CORINFO_CONTEXT_HANDLE context,
...
void interceptor_ICJI::findCallSiteSig(CORINFO_MODULE_HANDLE  module,
                                       unsigned               methTOK,
                                       CORINFO_CONTEXT_HANDLE context,
                                       CORINFO_SIG_INFO*      sig)
{
...
CORINFO_CLASS_HANDLE interceptor_ICJI::getTokenTypeAsHandle(CORINFO_RESOLVED_TOKEN* pResolvedToken)
{
...
size_t interceptor_ICJI::printObjectDescription(CORINFO_OBJECT_HANDLE handle,
                                                char*                 buffer,
                                                size_t                bufferSize,
...
unsigned interceptor_ICJI::getClassGClayout(CORINFO_CLASS_HANDLE cls, uint8_t* gcPtrs)
{
    mcs->AddCall("getClassGClayout");
    return original_ICorJitInfo->getClassGClayout(cls, gcPtrs);
}

unsigned interceptor_ICJI::getClassNumInstanceFields(CORINFO_CLASS_HANDLE cls)
{
    mcs->AddCall("getClassNumInstanceFields");
    return original_ICorJitInfo->getClassNumInstanceFields(cls);
}

CORINFO_FIELD_HANDLE interceptor_ICJI::getFieldInClass(CORINFO_CLASS_HANDLE clsHnd, int32_t num)
{
...
bool interceptor_ICJI::checkMethodModifier(CORINFO_METHOD_HANDLE hMethod, const char* modifier, bool fOptional)
{
...
bool interceptor_ICJI::isObjectImmutable(CORINFO_OBJECT_HANDLE objPtr)
{
...
CORINFO_CLASS_HANDLE interceptor_ICJI::getObjectType(CORINFO_OBJECT_HANDLE objPtr)
{
...
CorInfoInitClassResult interceptor_ICJI::initClass(CORINFO_FIELD_HANDLE   field,
...
bool interceptor_ICJI::canCast(CORINFO_CLASS_HANDLE child, CORINFO_CLASS_HANDLE parent)
{
    mcs->AddCall("canCast");
...
CorInfoIsAccessAllowedResult interceptor_ICJI::canAccessClass(CORINFO_RESOLVED_TOKEN* pResolvedToken,
...
size_t interceptor_ICJI::printFieldName(CORINFO_FIELD_HANDLE field,
                                        char*                buffer,
                                        size_t               bufferSize,
                                        size_t*              pRequiredBufferSize)
{
...
void interceptor_ICJI::getBoundaries(CORINFO_METHOD_HANDLE         ftn,
...
void interceptor_ICJI::setBoundaries(CORINFO_METHOD_HANDLE ftn, uint32_t cMap, ICorDebugInfo::OffsetMapping* pMap)
{
    mcs->AddCall("setBoundaries");
    original_ICorJitInfo->setBoundaries(ftn, cMap, pMap);
}

void interceptor_ICJI::getVars(CORINFO_METHOD_HANDLE      ftn,
                               uint32_t*                  cVars,
...
void interceptor_ICJI::setVars(CORINFO_METHOD_HANDLE ftn, uint32_t cVars, ICorDebugInfo::NativeVarInfo* vars)
{
    mcs->AddCall("setVars");
...
CORINFO_ARG_LIST_HANDLE interceptor_ICJI::getArgNext(CORINFO_ARG_LIST_HANDLE args)
{
...
int interceptor_ICJI::getExactClasses(CORINFO_CLASS_HANDLE  baseType,
                                      int                   maxExactClasses,
...
CORINFO_CLASS_HANDLE interceptor_ICJI::getArgClass(CORINFO_SIG_INFO* sig, CORINFO_ARG_LIST_HANDLE args)
{
...
bool interceptor_ICJI::runWithErrorTrap(ICorJitInfo::errorTrapFunction function, void* parameter)
{
    mcs->AddCall("runWithErrorTrap");
    return original_ICorJitInfo->runWithErrorTrap(function, parameter);
}

bool interceptor_ICJI::runWithSPMIErrorTrap(ICorJitInfo::errorTrapFunction function, void* parameter)
{
...
const char* interceptor_ICJI::getMethodNameFromMetadata(CORINFO_METHOD_HANDLE ftn,
...
unsigned interceptor_ICJI::getMethodHash(CORINFO_METHOD_HANDLE ftn)
{
...
void interceptor_ICJI::getFunctionEntryPoint(CORINFO_METHOD_HANDLE ftn,
...
void* interceptor_ICJI::GetCookieForPInvokeCalliSig(CORINFO_SIG_INFO* szMetaSig, void** ppIndirection)
{
...
void interceptor_ICJI::getCallInfo(CORINFO_RESOLVED_TOKEN* pResolvedToken,
...
bool interceptor_ICJI::convertPInvokeCalliToCall(CORINFO_RESOLVED_TOKEN* pResolvedToken, bool mustConvert)
{
    mcs->AddCall("convertPInvokeCalliToCall");
    return original_ICorJitInfo->convertPInvokeCalliToCall(pResolvedToken, mustConvert);
}

bool interceptor_ICJI::notifyInstructionSetUsage(CORINFO_InstructionSet instructionSet, bool supportEnabled)
{
...
void interceptor_ICJI::reserveUnwindInfo(bool isFunclet, bool isColdCode, uint32_t unwindSize)
{
    mcs->AddCall("reserveUnwindInfo");
    original_ICorJitInfo->reserveUnwindInfo(isFunclet, isColdCode, unwindSize);
}

void interceptor_ICJI::allocUnwindInfo(uint8_t*       pHotCode,
                                       uint8_t*       pColdCode,
...
void interceptor_ICJI::setEHinfo(unsigned EHnumber, const CORINFO_EH_CLAUSE* clause)
{
...
JITINTERFACE_HRESULT interceptor_ICJI::getPgoInstrumentationResults(CORINFO_METHOD_HANDLE                   ftnHnd,
...
JITINTERFACE_HRESULT interceptor_ICJI::allocPgoInstrumentationBySchema(CORINFO_METHOD_HANDLE                  ftnHnd,
                                                                       ICorJitInfo::PgoInstrumentationSchema* pSchema,
                                                                       uint32_t  countSchemaItems,
                                                                       uint8_t** pInstrumentationData)
{
    mcs->AddCall("allocPgoInstrumentationBySchema");
    return original_ICorJitInfo->allocPgoInstrumentationBySchema(ftnHnd, pSchema, countSchemaItems,
                                                                 pInstrumentationData);
}

void interceptor_ICJI::recordCallSite(uint32_t              instrOffset,
...
uint32_t interceptor_ICJI::getJitFlags(CORJIT_FLAGS* flags, uint32_t sizeInBytes)
{
