...
namespace Microsoft.Interop
{
    ...
    public class StructMarshallingGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            context.RegisterSourceOutput(
                ...
                (context, data) =>
                {
                    ...
                    context.AddSource("GeneratedStructMarshalling.g.cs", data.source);
                });
        }
            ...
            StructDeclarationSyntax nativeMarshallingStruct)
        {
            ...
            for (TypeDeclarationSyntax containingType = originalSyntax; containingType is not null; containingType = containingType.Ancestors().OfType<TypeDeclarationSyntax>().FirstOrDefault())
            {
